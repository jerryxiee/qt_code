...
MainWindow::MainWindow(QWidget *parent) : QWidget(parent),mVdecStart(false)
{
...
//    mQuickWidget->setSource(source);
    ...
    connect(WatchdButton,SIGNAL(clicked()),this,SLOT(onWatchdButtonClick()));
    QPushButton *OpenButton = new QPushButton(tr("打开"), this);
    OpenButton->setFont(font);
    connect(OpenButton,SIGNAL(clicked()),this,SLOT(onOpenButtonClick()));
    QPushButton *CloseButton = new QPushButton(tr("关闭"), this);
    CloseButton->setFont(font);
    connect(CloseButton,SIGNAL(clicked()),this,SLOT(onCloseButtonClick()));
...
//    mFileTabWidget->setColumnWidth(1,150);
    ...
    connect(mFileTabWidget,SIGNAL(cellDoubleClicked(int,int)),this,SLOT(testSlot(int,int)));
...
//    back->hide();
    connect(mback,SIGNAL(clicked()),this,SLOT(onBackButtonClick()));
...
void MainWindow::slotDirShow(QString &filename)
{
...
void MainWindow::onWatchdButtonClick()
{

}

void MainWindow::onOpenButtonClick()
{
...
void MainWindow::onStartVdecSlot()
{
