...
#define SEEK_FLAG_FRONT    1 ///< seek backward
#define SEEK_FLAG_BACK            2 ///< seeking based on position in bytes
#define SEEK_FLAG_ANY             4 ///< seek to any frame, even non-keyframes
//#define SEEK_FLAG_FRAME           8 ///< seeking based on frame number

MP4V2_EXPORT
bool MP4SampleSeekToTime(MP4FileHandle hFile,MP4TrackId trackId,MP4Timestamp  when,int flag);


MP4V2_EXPORT
uint32_t MP4GetSyncSampleCount(MP4FileHandle hFile,MP4TrackId    trackId);

MP4V2_EXPORT
MP4SampleId MP4GetSyncSampleId(MP4FileHandle hFile,
                                MP4TrackId    trackId,
                                uint32_t  no);

MP4V2_EXPORT
MP4SampleId MP4GetCurSampleId(MP4FileHandle hFile,
                              MP4TrackId    trackId);

MP4V2_EXPORT
MP4SampleId MP4GetNextSyncSampleId(MP4FileHandle hFile,
                              MP4TrackId    trackId,
                                   MP4SampleId   sampleId);

MP4V2_EXPORT
MP4SampleId MP4GetSyncSampleIdNear(MP4FileHandle hFile,
                              MP4TrackId    trackId,
                               MP4SampleId   sampleId,
                               int flag);

MP4V2_EXPORT
bool MP4ReadCurSample(
    /* input parameters */
    MP4FileHandle hFile,
    MP4TrackId    trackId,
    /* input/output parameters */
