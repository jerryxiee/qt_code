...
#define DEFAULT_FORMAT      TP2802_5M20
   ...
   // unsigned long flags;
    ...
    case _IOC_NR(TP2802_SET_PTZ_DATA):
    {
        ...
        if( TP2827C == id[chip] )
        {
			...
			else if(PTZ_HDC_QHD == PTZ_data.mode  ) //HDC QHD
			{
    ...
    case _IOC_NR(TP2802_GET_PTZ_DATA):
    {
        ...
        if( TP2827 == id[chip] || TP2826 == id[chip] || TP2816 == id[chip] || TP2827C == id[chip])
        {
    ...
    case _IOC_NR(TP2802_SET_PTZ_NEW):
    {
        ...
        {
            TP2826_PTZ_new(chip, PTZ_data.ch, PTZ_data.mode );
            ...
            else if( PTZ_HDA_720P == PTZ_data.mode || PTZ_HDA_CVBS == PTZ_data.mode) //HDA 720p/960H
            {
								HDA_SetACPV1Data(chip, 0x55, 0x00);
								HDA_SetACPV1Data(chip, 0x58, 0x00);
								HDA_SetACPV1Data(chip, 0x5b, 0x00);
...
static int tp2802_set_video_mode(unsigned char chip, unsigned char mode, unsigned char ch, unsigned char std)
{
    ...
    case TP2802_1080P25:
        ...
        if(TP2827C  == id[chip]) TP2827C_V1_DataSet(chip);
    ...
    case TP2802_720P25:
        ...
        if(TP2816  == id[chip]) TP2826_V1_DataSet(chip);
        if(TP2827  == id[chip]) TP2826_V1_DataSet(chip);
        if(TP2827C  == id[chip]) TP2826_V1_DataSet(chip);
    ...
    case TP2802_720P30V2:
        ...
        if(TP2827C  == id[chip]) TP2827C_V2_DataSet(chip);
    ...
    case TP2802_PAL:
        ...
        if(TP2827C  == id[chip]) TP2827C_PAL_DataSet(chip);
    ...
    case TP2802_NTSC:
        ...
        if(TP2827C  == id[chip]) TP2827C_NTSC_DataSet(chip);
    ...
    case TP2802_5M12:
        ...
        if( STD_HDA == std)
        {
                    ...
                    {
                        TP2827_A5MP12_DataSet(chip);
                    }
                    if(TP2827C == id[chip])
                    {
                        TP2827C_A5MP12_DataSet(chip);
                    }
        }
        tp282x_SYSCLK_V1(chip, ch);
        break;
    ...
    case TP2802_QHD30:
        ...
        if(TP2853C == id[chip]) {tp2802_set_work_mode_QHDH30(chip); TP2827_QHDH30_25_DataSet(chip);}
        if(TP2826  == id[chip]) {tp2802_set_work_mode_QHD30(chip); TP2827_QHDP30_25_DataSet(chip);}
        if(TP2827  == id[chip]) {tp2802_set_work_mode_QHD30(chip); TP2827_QHDP30_25_DataSet(chip);}
        if(TP2827C  == id[chip]) {tp2802_set_work_mode_QHD30(chip); TP2827C_QHDP30_25_DataSet(chip);}
        ...
        if( STD_HDA == std)
        {
                    ...
                    if(TP2827C  == id[chip]) TP2827C_AQHDP30_DataSet(chip);
        }
        else if(STD_HDC == std || STD_HDC_DEFAULT == std)
        {
                    ...
                    if(TP2827C  == id[chip]) TP2827C_CQHDP30_DataSet(chip);
        }
    ...
    case TP2802_QHD25:
        ...
        if(TP2853C == id[chip]) {tp2802_set_work_mode_QHDH25(chip); TP2827_QHDH30_25_DataSet(chip);}
        if(TP2826  == id[chip]) {tp2802_set_work_mode_QHD25(chip); TP2827_QHDP30_25_DataSet(chip);}
        if(TP2827  == id[chip]) {tp2802_set_work_mode_QHD25(chip); TP2827_QHDP30_25_DataSet(chip);}
        if(TP2827C  == id[chip]) {tp2802_set_work_mode_QHD25(chip); TP2827C_QHDP30_25_DataSet(chip);}
        ...
        if( STD_HDA == std)
        {
                    ...
                    if(TP2827C  == id[chip]) TP2827C_AQHDP25_DataSet(chip);
        }
        else if(STD_HDC == std || STD_HDC_DEFAULT == std)
        {
                    ...
                    if(TP2827C  == id[chip]) TP2827C_CQHDP25_DataSet(chip);
        }
    ...
    case TP2802_QXGA25:
        ...
        if(TP2826  == id[chip]) {tp2802_set_work_mode_QXGA25(chip); TP2827_AQXGAP25_DataSet(chip);}
        if(TP2827  == id[chip]) {tp2802_set_work_mode_QXGA25(chip); TP2827_AQXGAP25_DataSet(chip);}
        if(TP2827C  == id[chip]) {tp2802_set_work_mode_QXGA25(chip); TP2827C_AQXGAP25_DataSet(chip);}
        //if( STD_HDA == std)
        {
                    ...
                    //if(TP2826C  == id[chip]) TP2827_AQXGAP25_DataSet(chip);
                    //if(TP2827C  == id[chip]) TP2827_AQXGAP25_DataSet(chip);
        }
    ...
    case TP2802_QXGA30:
        ...
        if(TP2826  == id[chip]) {tp2802_set_work_mode_QXGA30(chip); TP2827_AQXGAP30_DataSet(chip);}
        if(TP2827  == id[chip]) {tp2802_set_work_mode_QXGA30(chip); TP2827_AQXGAP30_DataSet(chip);}
        if(TP2827C  == id[chip]) {tp2802_set_work_mode_QXGA30(chip); TP2827C_AQXGAP30_DataSet(chip);}
        //if( STD_HDA == std)
        {
                    ...
                    //if(TP2826C  == id[chip]) TP2827_AQXGAP30_DataSet(chip);
                    //if(TP2827C  == id[chip]) TP2827_AQXGAP30_DataSet(chip);
        }
    ...
    case TP2802_5M20:
        ...
        if(TP2853C == id[chip]) {tp2802_set_work_mode_5MH20(chip); TP2827_5MH20_DataSet(chip);}
        if(TP2826  == id[chip]) {tp2802_set_work_mode_5M20(chip); TP2827_5MP20_DataSet(chip);}
        if(TP2827  == id[chip]) {tp2802_set_work_mode_5M20(chip); TP2827_5MP20_DataSet(chip);}
        if(TP2827C  == id[chip]) {tp2802_set_work_mode_5M20(chip); TP2827C_5MP20_DataSet(chip);}
        if( STD_HDA == std)
        {
                    if(TP2853C == id[chip]) TP2827_A5MH20_DataSet(chip);
                    if(TP2826  == id[chip]) TP2827_A5MP20_DataSet(chip);
                    if(TP2827  == id[chip]) TP2827_A5MP20_DataSet(chip);
                    if(TP2827C  == id[chip]) TP2827C_A5MP20_DataSet(chip);
        }
    ...
    case TP2802_8M15:
        ...
        //if(TP2853C == id[chip]) {tp2802_set_work_mode_5MH20(chip); TP2827_5MH20_DataSet(chip);}
        if(TP2826  == id[chip]) {tp2802_set_work_mode_8M15(chip); TP2827_8MP15_DataSet(chip);}
        if(TP2827  == id[chip]) {tp2802_set_work_mode_8M15(chip); TP2827_8MP15_DataSet(chip);}
        if(TP2827C  == id[chip]) {tp2802_set_work_mode_8M15(chip); TP2827C_8MP15_DataSet(chip);}
...
*/
        ...
        else if( TP2827 == id[chip] || TP2827C == id[chip])
        {
            tmp = tp28xx_byte_read(chip,0x46);
            tmp |= SYS_MODE[ch];
            tp28xx_byte_write(chip, 0x46, tmp);
    ...
    else if(SDR_1CH == output[chip])
    {
        ...
        else if( TP2827C == id[chip] || TP2827 == id[chip] || TP2834 == id[chip] || id[chip] < TP2822 )
        {
    ...
    {
        if(TP2827 == id[chip] || TP2827C == id[chip])
        {
            if( ch >= CH_ALL ) //four ports
            {
                for(i = 0; i < 4; i++)
...
static void TP28xx_reset_default(int chip, unsigned char ch)
{
    ...
    else if(TP2827C == id[chip] )
    {
        TP2827C_reset_default(chip, ch);
    }
...
static void TP2826_PTZ_mode(unsigned char chip, unsigned char ch, unsigned char mod)
{
    ...
    static const unsigned char PTZ_dat[][12]=
    {
        ...
        {0x42,0x00,0x00,0x00,0x00,0x0f,0x10,0x00,0x00,0x4d,0xf0,0x6f}, //960H for 2826
        {0x42,0x00,0x00,0x00,0x00,0x10,0x11,0x12,0x15,0x15,0xb8,0xa2}, //HDC for 2826
        ...
        {0x42,0x00,0x00,0x00,0x00,0x0f,0x10,0x11,0x16,0x19,0xd0,0x17}, //ACP 4M2530_5M20 for 2826 4+0.35
        {0x42,0x00,0x00,0x00,0x00,0x0f,0x10,0x11,0x16,0x2c,0xf0,0x57}, //ACP 4M15 5M12.5 for 2826 8+0.6
...
static void TP2826_PTZ_new(unsigned char chip, unsigned char ch, unsigned char mod)
{
    ...
    static const unsigned char PTZ_dat[][12]=
    {
        {0x02,0x00,0x20,0x00,0x00,0x0b,0x0c,0x0d,0x0e,0x19,0x78,0x21}, //TVI1.0
        {0x02,0x00,0x20,0x00,0x00,0x0b,0x0c,0x0d,0x0e,0x33,0xf0,0x21}, //TVI2.0
        {0x02,0x00,0x20,0x00,0x00,0x0e,0x0f,0x10,0x11,0x26,0xf0,0x57}, //A1080p for 2826 0.525
        {0x02,0x00,0x20,0x00,0x00,0x0e,0x0f,0x00,0x00,0x26,0xe0,0xef}, //A720p for 2826 0.525
        {0x02,0x00,0x20,0x00,0x00,0x0f,0x10,0x00,0x00,0x4d,0xf0,0x6f}, //960H for 2826
        {0x02,0x00,0x20,0x00,0x00,0x10,0x11,0x12,0x15,0x15,0xb8,0xa2}, //HDC for 2826
        {0x02,0x00,0x20,0x00,0x00,0x0f,0x10,0x11,0x12,0x2c,0xf0,0x57}, //ACP 3M18 for 2826 8+0.6
        {0x02,0x00,0x20,0x00,0x00,0x0f,0x10,0x11,0x12,0x19,0xd0,0x17}, //ACP 3M2530 for 2826 4+0.35
        {0x02,0x00,0x20,0x00,0x00,0x0f,0x10,0x12,0x16,0x19,0xd0,0x17}, //ACP 4M2530_5M20 for 2826 4+0.35
        {0x02,0x00,0x20,0x00,0x00,0x0f,0x10,0x12,0x16,0x2c,0xf0,0x57}, //ACP 4M15 5M12.5 for 2826 8+0.6
...
//        {0x46,0x5f,0x00,0x00,0x00,0x0f,0x10,0x12,0x16,0x2c,0xf0,0x57}, //ACP 4M15 5M12.5 for 2826 8+0.6
        {0x02,0x00,0x20,0x00,0x00,0x16,0x17,0x18,0x19,0x2a,0xff,0x1a}, //HDC QHD25/30 for 2826
    };
    tp28xx_byte_write(chip, 0x40, ch); //reg bank1 switch for 2826
...
static void tp2802_comm_init( int chip)
{
    ...
    if(TP2827C == id[chip] )
    {
        TP2827C_reset_default(chip, CH_ALL);
        ...
        TP2827C_RX_init(chip, PTZ_RX_ACP1);
        ...
        //debug
       tp28xx_byte_write(chip, 0x40, 0x0);
...
#define SCSYSID_REG         ioremap(0x12050EE8,0xff)
...
static int __init tp2802_module_init(void)
{
  ...
  //  printk("Compiled %s %s\n", __DATE__, __TIME__);
    ...
    for (i = 0; i < chips; i ++)
    {
        ...
        if(0x2601 == id[i] || 0x2619 == id[i] || 0x260c == id[i] || 0x270c == id[i])
        {
            TP2816_PLL_Reset(i);
        }

        printk("scsysid 0x%x,id 0x%x\n",scsysid,id[i]);
                    ...
                    if(SCAN_MANUAL != wdi->scan[i])
                    {
...

                        {
                            ...
                            else //format is 7
                            {
                                ...
                                if( TP2853C == id[iChip] || TP2826 == id[iChip] || TP2827 == id[iChip] || TP2827C == id[iChip])//3M auto detect test
                                {
                            ...
                            if( TP2826 == id[iChip] || TP2827 == id[iChip] || TP2827C == id[iChip])// new 3M20/4M12 auto detect test
                            {
                ...
                if( VIDEO_LOCKED == wdi->state[i]) //check signal lock
                {
                    if(0 == wdi->count[i] )
                    {
                        //if(SCAN_MANUAL == wdi->scan[i])
                        {
                            ...
                            else if(TP2833 == id[iChip] || TP2833C == id[iChip] || TP2853C == id[iChip] || TP2823C == id[iChip] || TP2826 == id[iChip] || TP2816 == id[iChip] || TP2827 == id[iChip] || TP2827C == id[iChip])
                            {
                            	tmp = tp28xx_byte_read(iChip, 0x26);
                            	tmp |= 0x01;
                            	tp28xx_byte_write(iChip, 0x26, tmp);
                        ...
                        if( (SCAN_AUTO == wdi->scan[i] || SCAN_TVI == wdi->scan[i] ))
                        {
                            ...
                            if( id[iChip] >= TP2822 )
                            {
                                ...
                                if( TP2826 == id[iChip] || TP2816 == id[iChip] || TP2827 == id[iChip] || TP2827C == id[iChip])
                                {
                    ...
                    else if(wdi->count[i] == EQ_COUNT+EQ_COUNT+1)
                    {
                        ...
                        else if( id[iChip] > TP2823 )
                        {
                            ...
                            if( STD_TVI != wdi-> std[i] )
                            {
                                    ...
                                    if(STD_HDC == wdi-> std[i]) //fine tune CVI
                                    {
