...
static HI_BOOL bExit   = HI_FALSE;
static HI_BOOL bTravel = HI_FALSE;
static HI_BOOL bShape1 = HI_FALSE;
static HI_BOOL bShape2 = HI_FALSE;
static HI_BOOL bArea   = HI_FALSE;
...
static HI_S32 VDEC_SendEos(VDEC_CHN Vdchn)
{
    return HI_SUCCESS;
}
