...
HI_S32 SAMPLE_VIO_8_1080P(HI_VOID)
{
	...
	******************************************/
    ...
    stVoPubAttr_hd0.enIntfSync = VO_OUTPUT_720P50;
    stVoPubAttr_hd0.enIntfType = VO_INTF_VGA;
    stVoPubAttr_hd0.u32BgColor = 0xFF;
	...
	******************************************/
	...
	while(1)
	{
		...
		{
            HI_MPI_VI_Query(0, &vi_chn_stat);
            printf("vi chn 0 interrupt count:%d\n",vi_chn_stat.u32IntCnt);
