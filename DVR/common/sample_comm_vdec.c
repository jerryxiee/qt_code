...
static VB_POOL g_ahVbPool[VB_MAX_POOLS] = {[0 ... (VB_MAX_POOLS-1)] = VB_INVALID_POOLID};
...
HI_VOID	SAMPLE_COMM_VDEC_Sysconf(VB_CONF_S *pstVbConf, SIZE_S *pstSize)
{
    ...
    pstVbConf->astCommPool[0].u32BlkSize = CEILING_2_POWER(pstSize->u32Width,SAMPLE_SYS_ALIGN_WIDTH)\
            * CEILING_2_POWER(pstSize->u32Height,SAMPLE_SYS_ALIGN_WIDTH) *2;//(pstSize->u32Width * pstSize->u32Height * 4) >> 1;
