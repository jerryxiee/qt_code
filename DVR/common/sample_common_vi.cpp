...
Sample_Common_Vi::Sample_Common_Vi()
{

}

HI_S32 Sample_Common_Vi::SAMPLE_TW2865_CfgV(VIDEO_NORM_E enVideoMode,VI_WORK_MODE_E enWorkMode)
{
#if 0
    int fd, i;
    int video_mode;
...
HI_S32 Sample_Common_Vi::SAMPLE_TW2960_CfgV(VIDEO_NORM_E enVideoMode,VI_WORK_MODE_E enWorkMode)
{
#if 0
    int fd, i;
    int video_mode;
...
HI_S32 Sample_Common_Vi::SAMPLE_NVP6134_CfgV(SAMPLE_VI_MODE_E enViMode, VIDEO_NORM_E enVideoMode, VI_WORK_MODE_E enWorkMode)
{
#ifndef HI_FPGA
    int fd, i,j;
    int video_mode;
...
HI_S32 Sample_Common_Vi::SAMPLE_TP2823_CfgV(VIDEO_NORM_E enVideoMode,VI_WORK_MODE_E enWorkMode)
{
    return 0;
}
...
*****************************************************************************/
HI_VOID Sample_Common_Vi::SAMPLE_COMM_VI_SetMask(VI_DEV ViDev, VI_DEV_ATTR_S *pstDevAttr)
{
    switch (ViDev % 2)
      {
          case 0:
...
HI_S32 Sample_Common_Vi::SAMPLE_COMM_VI_Mode2Param(SAMPLE_VI_MODE_E enViMode, SAMPLE_VI_PARAM_S *pstViParam)
{
    switch (enViMode)
    {
...
*****************************************************************************/
HI_S32 Sample_Common_Vi::SAMPLE_COMM_VI_ADStart(SAMPLE_VI_MODE_E enViMode, VIDEO_NORM_E enNorm)
{
...
* function : get vi parameter, according to vi type
*****************************************************************************/
HI_S32 Sample_Common_Vi::SAMPLE_COMM_VI_Mode2Size(SAMPLE_VI_MODE_E enViMode, VIDEO_NORM_E enNorm, RECT_S *pstCapRect, SIZE_S *pstDestSize)
{
    pstCapRect->s32X = 0;
    pstCapRect->s32Y = 0;
    switch (enViMode)
...
*****************************************************************************/
VI_DEV Sample_Common_Vi::SAMPLE_COMM_VI_GetDev(SAMPLE_VI_MODE_E enViMode, VI_CHN ViChn)
{
...
*****************************************************************************/
HI_S32 Sample_Common_Vi::SAMPLE_COMM_VI_StartDev(VI_DEV ViDev, SAMPLE_VI_MODE_E enViMode)
{
    HI_S32 s32Ret;
...
*****************************************************************************/
HI_S32 Sample_Common_Vi::SAMPLE_COMM_VI_StartChn(VI_CHN ViChn, RECT_S *pstCapRect, SIZE_S *pstTarSize,
...
*****************************************************************************/
HI_S32 Sample_Common_Vi::SAMPLE_COMM_VI_Start(SAMPLE_VI_MODE_E enViMode, VIDEO_NORM_E enNorm)
{
    VI_DEV ViDev;
    VI_CHN ViChn;
    HI_S32 i;
...
HI_S32 Sample_Common_Vi::SAMPLE_COMM_VI_Start(VI_CHN ViChn,SAMPLE_VI_MODE_E enViMode, VIDEO_NORM_E enNorm)
{
    VI_DEV ViDev;
    VI_CHN Chn;
//    HI_S32 i;
...
HI_S32 Sample_Common_Vi::SAMPLE_COMM_VI_SetFrameDepth(VI_CHN ViChn, HI_U32 u32Depth)
{
    HI_S32 s32ret;
...
HI_S32 Sample_Common_Vi::SAMPLE_COMM_VI_GetFrame(VI_CHN ViChn, VIDEO_FRAME_INFO_S *pstFrameInfom,HI_S32 s32MilliSec)
{
    HI_S32 s32ret;
...
HI_S32 Sample_Common_Vi::SAMPLE_COMM_VI_VI_ReleaseFrame(VI_CHN ViChn, VIDEO_FRAME_INFO_S*pstFrameInfo)
{
    HI_S32 s32ret;
...
HI_S32 Sample_Common_Vi::SAMPLE_COMM_VI_GetChnLuma(SAMPLE_VI_MODE_E enViMode,VI_CHN ViChn, VI_CHN_LUM_S *pstLuma)
{
    HI_S32 s32Ret;
    SAMPLE_VI_PARAM_S stViParam;
...
*****************************************************************************/
HI_S32 Sample_Common_Vi::SAMPLE_COMM_VI_Stop(SAMPLE_VI_MODE_E enViMode)
{
    VI_DEV ViDev;
    VI_CHN ViChn;
    HI_S32 i;
...
*****************************************************************************/
HI_S32 Sample_Common_Vi::SAMPLE_COMM_VI_BindVpss(SAMPLE_VI_MODE_E enViMode, VPSS_GRP *Vpss_GrpTab, HI_S32 Vpss_nGrp)
{
    HI_S32 j, s32Ret;
//    VPSS_GRP VpssGrp;
    VPSS_GRP nVpssGrp;
...
*****************************************************************************/
HI_S32 Sample_Common_Vi::SAMPLE_COMM_VI_UnBindVpss(SAMPLE_VI_MODE_E enViMode, VPSS_GRP *Vpss_GrpTab, HI_S32 Vpss_nGrp)
{
    HI_S32 i, j, s32Ret;
    VPSS_GRP VpssGrp;
    MPP_CHN_S stSrcChn;
...
HI_S32 Sample_Common_Vi::SAMPLE_COMM_VI_BindVo(VI_CHN ViChn, VO_LAYER VoLayer, VO_CHN VoChn)
{
    MPP_CHN_S stSrcChn;
    MPP_CHN_S stDestChn;
...
HI_S32 Sample_Common_Vi::SAMPLE_COMM_VI_UnBindVo(VI_CHN ViChn,VO_LAYER VoLayer, VO_CHN VoChn)
{
    MPP_CHN_S stSrcChn;
    MPP_CHN_S stDestChn;
