...
******************************************************************************/
#if 1
HI_S32 Sample_Common_Venc::SAMPLE_COMM_VENC_Start()
{
    HI_S32 s32Ret;
    VENC_CHN_ATTR_S stVencChnAttr;
    ...
    SIZE_S stPicSize;
    s32Ret = Sample_Common_Sys::SAMPLE_COMM_SYS_GetPicSize(m_enNorm, m_enSize, &stPicSize);
    if (HI_SUCCESS != s32Ret)
    {
        SAMPLE_PRT("Get picture size failed!\n");
        return HI_FAILURE;
     ...
     ******************************************/
    stVencChnAttr.stVeAttr.enType = m_enType;
    switch (m_enType)
    {
        case PT_H264:
        {
            ...
            stH264Attr.u32Profile  = m_u32Profile;/*0: baseline; 1:MP; 2:HP;  3:svc_t */
            ...
            if (SAMPLE_RC_CBR == m_enRcMode)
            {
                ...
                if(m_u32BitRate == 0){
                    ...
                    stH264Cbr.u32BitRate = m_u32BitRate;
                }
                stH264Cbr.u32FluctuateLevel = 1; /* average bit rate */
                memcpy(&stVencChnAttr.stRcAttr.stAttrH264Cbr, &stH264Cbr, sizeof(VENC_ATTR_H264_CBR_S));
            }
            else if (SAMPLE_RC_FIXQP == m_enRcMode)
            {
                stVencChnAttr.stRcAttr.enRcMode = VENC_RC_MODE_H264FIXQP;
            ...
            else if (SAMPLE_RC_VBR == m_enRcMode)
            {
                stVencChnAttr.stRcAttr.enRcMode = VENC_RC_MODE_H264VBR;
                ...
                if(m_u32BitRate == 0){
                    ...
                    stH264Vbr.u32MaxBitRate = m_u32BitRate;
                }
                memcpy(&stVencChnAttr.stRcAttr.stAttrH264Vbr, &stH264Vbr, sizeof(VENC_ATTR_H264_VBR_S));
            }
            else if (SAMPLE_RC_AVBR == m_enRcMode)
            {
                stVencChnAttr.stRcAttr.enRcMode = VENC_RC_MODE_H264AVBR;
                ...
                if(m_u32BitRate == 0){
                    ...
                    stH264AVbr.u32MaxBitRate = m_u32BitRate;
                }
        ...
        case PT_MJPEG:
        {
            ...
            else if (SAMPLE_RC_CBR == m_enRcMode)
            {
                stVencChnAttr.stRcAttr.enRcMode = VENC_RC_MODE_MJPEGCBR;
                ...
                if(m_u32BitRate == 0){
                    ...
                    stVencChnAttr.stRcAttr.stAttrMjpegeCbr.u32BitRate = m_u32BitRate;
                }
            }
            else if (SAMPLE_RC_VBR == m_enRcMode)
            {
                ...
                stVencChnAttr.stRcAttr.stAttrMjpegeVbr.u32SrcFrmRate = (VIDEO_ENCODING_MODE_PAL == m_enNorm) ? 25 : 30;
                ...
                if(m_u32BitRate == 0){
                    ...
                    stVencChnAttr.stRcAttr.stAttrMjpegeVbr.u32MaxBitRate = m_u32BitRate;
                }
            }
            else
            {
        ...
        case PT_H265:
        {
            ...
            {
                stH265Attr.u32Profile  = m_enRcMode;
            }/*0:MP*/
            ...
            if (SAMPLE_RC_CBR == m_enRcMode)
            {
                ...
                if(m_u32BitRate == 0){
                    ...
                    stH265Cbr.u32BitRate = m_u32BitRate;
                }
            ...
            else if (SAMPLE_RC_VBR == m_enRcMode)
            {
                ...
                if(m_u32BitRate == 0){
                    ...
                    stH265Vbr.u32MaxBitRate = m_u32BitRate;
                }
            ...
            else if (SAMPLE_RC_AVBR == m_enRcMode)
            {
                ...
                if(m_u32BitRate == 0){
                    ...
                    stH265AVbr.u32MaxBitRate = m_u32BitRate;
                }
